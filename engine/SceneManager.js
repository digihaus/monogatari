...
Monogatari.SceneManager = new MonogatariSceneManager();
  ...
  function MonogatariSceneManager() {
    ...
    this._renderer = Detector.webgl? new THREE.WebGLRenderer( { antialias : true } ): new THREE.CanvasRenderer();
...
//    this._lightIterator = this._lights.iterator();
  ...
  MonogatariSceneManager.prototype.createCamera = function( cameraId, sceneId ) {
    ...
    if( scene ) {
      ...
      var camera = new Monogatari.Camera2D( this._canvasWidth / -2, 
                                            this._canvasWidth / 2, 
