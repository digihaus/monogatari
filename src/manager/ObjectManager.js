define( [ 'collection/Tree',
  ...
  MonogatariObjectManager.prototype.getGlobalPosition = function( id ) {
    if ( this._objects.contains( id ) ) {
      if ( this._objects.get( id ).parent === 'trunk' ) {
        return this._objects.get( id ).value.findComponent( _Base.COMPONENT_NODE ).position;
      } else {
        var parentPosition = this.getGlobalPosition( this._objects.get( id ).parent );
        var position = this._objects.get( id ).value.findComponent( _Base.COMPONENT_NODE ).position.clone();
  ...
  MonogatariObjectManager.prototype.getGlobalRotation = function( id ) {
    if ( this._objects.contains( id ) ) {
      if ( this._objects.get( id ).parent === 'trunk' ) {
        return this._objects.get( id ).value.findComponent( _Base.COMPONENT_NODE ).rotation;
      } else {
        var parentRotation = this.getGlobalRotation( this._objects.get( id ).parent );
        var rotation = this._objects.get( id ).value.findComponent( _Base.COMPONENT_NODE ).rotation.clone();
  ...
  MonogatariObjectManager.prototype.getGlobalScale = function( id ) {
    if ( this._objects.contains( id ) ) {
      if ( this._objects.get( id ).parent === 'trunk' ) {
        return this._objects.get( id ).value.findComponent( _Base.COMPONENT_NODE ).scale;
      } else {
        var parentScale = this.getGlobalScale( this._objects.get( id ).parent );
        var scale = this._objects.get( id ).value.findComponent( _Base.COMPONENT_NODE ).scale.clone();
  ...
  MonogatariObjectManager.prototype.getGlobalNode = function( id ) {
    if ( this._objects.contains( id ) ) {
      if ( this._objects.get( id ).parent === 'trunk' ) {
        ...
        var parentNode = this.getGlobalNode( this._objects.get( id ).parent ),
            node = new _Node( this._objects.get( id ).value.findComponent( _Base.COMPONENT_NODE ).position.clone(),
                                        this._objects.get( id ).value.findComponent( _Base.COMPONENT_NODE ).rotation.clone(),
                                        this._objects.get( id ).value.findComponent( _Base.COMPONENT_NODE ).scale.clone() );
